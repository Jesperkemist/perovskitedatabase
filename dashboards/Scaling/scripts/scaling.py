# =============================================================================
# Bokeh app focusing on scalability
# 
# By Jesper Jacobsson
# 2020 06
# =============================================================================
...
def make_plot(source, data, view, alphaValue, booleanCategory, colorLabels, currentRowsInData, legendCategory, legendFontSize, markerSize, newPlotWidth, tooltips, useColorMarkers, xAxisLogStart, xrange, x_axis, x_scale_select, yAxisLogStart, y_axis, y_scale_select):
    ...
    #        ("Cell total area", "@Cell_area_measured"),
...
def interactiveEngine():
    ...
    selects = {
        ...
        'x_axis' : Select(title="X-Axis", options=list(x_axis_map.keys()), value="Active cell area [cm^2]"),
        'x_scale_select' : Select(title="X-Axis scale", options=list(x_scale_select_map.keys()), value="log"),
    ...
    sliders = {
        ...
        'xAxisLogStart' : Slider(start=-5, end=5, value=-3, step=1, title="X-axis. log scale lower limit"),
