...
def interactiveEngine():
    ...
    selects = {
        ...
        'x_axis' : Select(title="X-axis category", options=list(legendCategory_map.keys()), value="Perovskite deposition procedure"),
    ...
    layout_tab1 = row(controls1, p, controls2, controls3, controls4, controls5, download_trigger)
