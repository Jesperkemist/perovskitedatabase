...
from dashboards.OutdoorTesting.scripts import outdoorTesting
from dashboards.OutdoorTesting.scripts import categoricalPlots
...
tab1, tab2, tab3, tab4 = outdoorTesting.interactiveEngine()
